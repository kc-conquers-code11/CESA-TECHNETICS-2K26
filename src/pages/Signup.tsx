        ...
        <div className="flex-1 relative overflow-hidden flex flex-col p-8 md:p-12 rounded-sm">
          ...
          <AnimatePresence mode="wait">
            <motion.div
              ...
              exit={{ opacity: 0, x: isVerified ? -20 : 20 }}
                  ...
                  <form onSubmit={handleSignup} className="relative z-10 space-y-6 w-full max-w-md mx-auto">
                    ...
                    <div className="space-y-3 py-2">
                      <div className="flex items-center gap-3">
                        ...
                        />
                        <label htmlFor="isObscure" className="text-sm font-crimson italic text-[#3d2618] cursor-pointer select-none font-bold">
                      ...
                      <div className="flex items-center gap-3">
                        ...
                        />
                        <label htmlFor="isDarkMark" className="text-sm font-crimson italic text-[#3d2618] cursor-pointer select-none font-bold">
