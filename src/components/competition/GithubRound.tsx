...
const GithubRound = () => {
    ...
    return (
        <div className="flex gap-4 h-full w-full animate-in fade-in duration-500 overflow-hidden">
            {/* MAIN CONTENT */}
            <div className="flex-1 bg-[#051112]/40 border border-[#d4af37]/20 rounded-2xl p-4 md:p-8 lg:p-12 shadow-2xl relative overflow-y-auto flex flex-col text-center">
                ...
                <div className="my-auto w-full max-w-4xl mx-auto flex flex-col pb-8">
                    <h2 className="text-4xl md:text-5xl font-wizard tracking-widest text-[#FFD700] mb-6 mt-8">
                        The Enchanted Link
                    </h2>
            ...
            {/* SIDEBAR */}
            <aside className="w-80 border-l border-[#d4af37]/10 bg-[#051112]/40 p-5 hidden xl:flex flex-col gap-6 overflow-y-auto">
                <div className="bg-black/40 rounded-xl p-4 border border-[#d4af37]/10 shrink-0">
