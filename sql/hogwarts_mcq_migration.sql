...
-- This script replaces existing Round 1 questions with thematic aptitude questions.

-- 1. Clear existing MCQ questions
DELETE FROM questions WHERE round_id = 'mcq';

-- 2. Insert new Hogwarts-themed aptitude questions
...
(
  ...
  '["1 goal", "2 goals", "None, they win anyway", "Harry cannot win the game"]',
  '2 goals',
  'medium'
),
-- 5. Hard - Time/Logic
...
(
  ...
  '["1/4", "More than 0 but less than 1", "Exactly 1", "0"]',
...
(
  ...
  'Pattern recognition.',
  '["Alohomora", "Lumos", "Nox", "Expelliarmus"]',
  'Nox',
  'easy'
),
...
(
  ...
  'Classic syllogism.',
  '["Cedric is a Prefect", "Cedric is a hard worker", "All hard workers are Hufflepuffs", "Hufflepuffs are never lazy"]',
...
(
  ...
  'Relative ordering.',
  '["Firebolt", "Nimbus", "Comet", "Cannot be determined"]',
  'Comet',
  'medium'
),
